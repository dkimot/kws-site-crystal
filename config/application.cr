...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Jumprope Cms Crystal web application."
  #
  #
  ...
  #
  # settings.secret_key_base= bPtHPGFF4EhXPCdbi49r-a2iDQqfNRxY9HBOtlPOY1Y
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("jumprope_cms-crystal.log", "w"))
  #
  #
end
